...
public class SelectMusicPage extends AppCompatActivity {
    Button backBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.select_song_page);
        ...
        btnStartGame.setOnClickListener(v -> {
            ...
            Intent intent = new Intent(this, GamePage.class); // ✅ 팀원이 만들 GameActivity
    ...
    private void seedSongs() {
        songs.clear();
        songs.add(new Song("s1", "candy_land",      0)); // baseScore는 이제 안 씀, 0으로 둬도 됨
        songs.add(new Song("s2", "luminous_memory",        0));
...
//        songs.add(new Song("s5", "5",           0));
    ...
    private int getPreviewResIdBySongId(String id) {
        switch (id) {
            case "s1": return R.raw.candy_land;
            case "s2": return R.raw.luminous_memory;
